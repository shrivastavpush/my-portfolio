        ...
        <section className="h-[calc(100vh-8rem)] bg-[#011627] p-4 md:p-8 overflow-y-auto">
            <div className="max-w-6xl mx-auto flex flex-col">
                <div className="text-center mb-8 bg-[#011627] pt-2 pb-4 z-10">
                    ...
                    <p className="text-emerald-300/80 font-fira-code text-sm md:text-base mt-4">A showcase of my technical skills and expertise</p>
                </div>
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <h3 className={`font-fira-code transition-colors duration-300 ${index === activeSkill ? 'text-emerald-400' : 'text-emerald-500/50'
                                            }`}>{skill.category}</h3>
                                    </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-[#01111d] rounded-xl p-6 border border-emerald-900/50 h-full">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-fira-code text-emerald-400 mb-2">{skills[activeSkill].category}</h3>

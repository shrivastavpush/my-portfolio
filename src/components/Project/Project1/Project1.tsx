...
const Project1: React.FC = () => {
    const projectDetails = {
        ...
        description: "A modern, responsive portfolio website built with React and TypeScript. Features a clean design, smooth animations, and interactive components. Implements best practices for accessibility and performance.",
        image: "/portfolio-preview.png", // Add your project image

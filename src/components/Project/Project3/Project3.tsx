...
import News_App from '../../../assets/images/news.webp';
...
const Project3: React.FC = () => {
    const projectDetails = {
        ...
        image: News_App,
        liveLink: "https://news-dot-com.netlify.app",
        githubLink: "https://github.com/shrivastavpush/news.com",
        techStack: [
            {
                category: "Frontend",
                items: ["React", "Bootstrap", "Fetch API"],
                icon: <FiCode />
            },
            {
                category: "UI/UX",
                items: ["Responsive Cards", "Category Filters", "Dynamic Loading"],
                icon: <FiLayout />
            },
            {
                category: "Features",
                items: ["NewsAPI Integration", "Real-time Updates", "Category Navigation"],
                icon: <FiTool />
            }
        ] as TechStack[]
    };
